...
type Repository interface {
	...
	ReleaseScooter(ctx context.Context, userID string) error
...
// ReleaseScooter ...
func ReleaseScooter(ctx context.Context, userID string) error {
	return repositoryImpl.ReleaseScooter(ctx, userID)
}
